...
# TODO: Look for supporting XFORMERS
# TODO: Update torch to support the latest version of interpolate
from  torch.nn.functional import interpolate
# from src.utils.functional import interpolate
...
class DinoVisionTransformer(nn.Module):
    def __init__(
        ...
        # Head used for classification TODO: Remove
    ...
    def forward(self, inputs, last_self_attention=False):
        ...
        assert len(idx_crops) <= 2, "Only supporting at most two different types of crops (global and local crops)"
        start_idx = 0
    ...
    def forward_backbone(self, x, last_self_attention=False):
        ...
        cls_token = out_dict["x_norm_clstoken"]
